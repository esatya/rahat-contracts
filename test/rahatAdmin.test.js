...
describe("Rahat contract", function() {
  ...
  describe("Sets the Project Budget", function() {
    ...
    it("Should set the project ERC1155 budget", async function() {   
        ...
        console.log({projec1_erc1155Balance})
  ...
  console.log({projec1_erc1155Balances})
  console.log(projec1_erc1155Balances.tokenIds);
